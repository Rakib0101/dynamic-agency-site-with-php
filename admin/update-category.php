...
?>
    <div class="col-md-10 mainbar">
        ...
        include 'config.php';
          ...
          $sql = "SELECT * FROM portfolio_category WHERE id ='{$cat_id}'";
          ...
          if (mysqli_num_rows($result) > 0) {
              ...
              <form action="<?php $_SERVER['PHP_SELF']; ?>" method ="POST">
                  <div class="form-group">
                      <input type="hidden" name="cat_id"  class="form-control" value="<?php echo $row['id']; ?>">
                  </div>
                  <div class="form-group">
        ...
        <?php
          if(isset($_POST['submit'])){
            ...
            $sql = "SELECT category_name FROM portfolio_category WHERE category_name='{$category}' AND NOT id='{$cat_id}'";
            ...
            if (mysqli_num_rows($result1)> 0) {
              ...
              $sql1 = "UPDATE portfolio_category SET id='{$_POST['cat_id']}', category_name='{$_POST['cat_name']}'  WHERE  id={$_POST['cat_id']}";
