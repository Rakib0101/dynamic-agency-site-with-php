    ...
    <div class="col-md-10 mainbar">
              ...
              <h2>Add Category:</h2>
                  ...
                  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" autocomplete="off">
                      ...
                      <input type="submit" name="save" class="btn btn-primary my-2" value="Save" required />
                  </form>
                  <!-- /Form End -->
                  <?php
                    if( isset($_POST['save']) ){
                        ...
                        $sql = "SELECT category_name FROM portfolio_category where category_name='{$category}'";
                        ...
                        if (mysqli_num_rows($result)> 0) {
                            ...
                            $sql = "INSERT INTO portfolio_category (category_name)
                                    VALUES ('{$category}')";

                            if (mysqli_query($conn, $sql)){
                                header("location: {$hostname}/admin/portfolio_category.php");
                            }else{
